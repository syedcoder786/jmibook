                    ...
                    <div class="container-fluid" style={{paddingLeft: '5px', paddingRight: '5px'}}>
                        ...
                        <ul class="navbar-nav me-auto mb-0 mb-lg-0">
                            ...
                            <Link to="/">
                                ...
                                <label class="btn btn-outline-secondary btn-sm" style={{paddingTop: '5px', color:"white"}} for="btnradio1">Feed</label>
                            </Link>
                            <Link to="/chat">
                            <div>
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off" onclick="window.location.href='chat.html'"/>
                                <label class="btn btn-outline-secondary btn-sm" style={{paddingTop: '5px', color:"white"}} for="btnradio2">Global Chat</label>
                            </div>
                            </Link>
                            <Link to="/new">
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off"  onclick="window.location.href='news.html'"/>
                                <label class="btn btn-outline-secondary btn-sm" style={{paddingTop: '5px', color:"white"}} for="btnradio3">News</label>
                            </Link>
                            <Link to="/nfts">
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off" />
                                <label class="btn btn-outline-secondary btn-sm" style={{paddingTop: '5px', color:"white"}} for="btnradio4">NFTs</label>
                            </Link>
                            </div>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
