        ...
        const postItems = this.state.posts.map((post, index) => (
            ...
            <div class="post">
                ...
                <tr>
                    ...
                    <td><strong><Link to={'/profile/' + post.user_id} style={{textDecoration:"none", color:"black"}}><a style={{textDecoration:"none", color:"black"}} href={'/profile/' + post.user_id}>{post.fname} {post.lname} </a></Link><br/>({this.props.user?post.branch:'Loading...'}, {this.props.user?post.semester:'Loading...'})</strong></td>
                ...
                <button class="like" id={post._id} onClick={(e)=>{this.onClick(e,post,index)}}>❤</button>
