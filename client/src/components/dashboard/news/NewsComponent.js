        ...
        <li class="single_comment_area">
            <div class="comment-content d-flex">
                <div class="comment-author">
                    <img src={comment.user_img} alt="author" style={{height:"70px"}}/>
                </div>
                <div class="comment-meta">
                    {/* <a href="#" class="post-date">March 12</a> */}
                    <Link style={{textDecoration: "none"}} to={"/profile/"+comment.user_id}><p><a class="post-author" style={{color:"silver"}}>{comment.fname} {comment.lname}</a></p></Link>
                    <p>{comment.comment}</p>
