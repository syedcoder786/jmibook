            ...
            <div class="panel panel-white post" style={{backgroundColor: "#D8D8D8", borderRadius:"5px"}}>
                <div class="post-heading">
                    <div class="pull-left image">
                        <img src={post.user_img} class="img-circle avatar" alt="user profile image"/>
                    </div>
                    <div class="pull-left meta">
                        <div class="title h6" style={{fontSize:"15px"}}>
                            <a><b>{post.fname} {post.lname}</b></a>
                            <span style={{fontSize:"12px"}}> ({post.semester})</span>
                        </div>
                        <h6 class="text-muted time">{post.branch}</h6>
                    </div>
                </div>
                    ...
                    {post.comments.map(comment => (
                        <li class="comment">
                            <a class="pull-left" href="javascript:void(0);">
                                <img class="avatar" src={comment.user_img} alt="avatar"/>
                            </a>
